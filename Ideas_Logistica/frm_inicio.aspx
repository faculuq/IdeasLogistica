<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frm_inicio.aspx.vb" Inherits="Ideas_Logistica.frm_inicio" %>
...
<section id="Acerca" class="content-section navbar-light" style="background-color: #F0F0F0" id="about">
  <div class="container wow zoomInLeft">
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <center><h2>ACERCA DEL SOFTWARE</h2></center>
          <hr/>
          <div class="row">
  ...
  <section id="Modulos" class="content-section text-white text-center navbar-light" id="services" style="background-color: whitesmoke">
    <div class="container wow zoomInRight">
      <div class="content-section-heading">
        <h3 class="text-secondary mb-0"></h3>
        <h2 class="mb-5" style="font-size: 35px; color: black;">MÓDULOS</h2>
